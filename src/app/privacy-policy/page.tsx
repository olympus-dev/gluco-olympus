...
export const metadata: Metadata = {
  title: "Privacy Policy | Endoterec©",
  description:
  ...
  return (
    <div>
      <main className="container mx-auto mt-6">
        ...
        <section>
          <h1 className="px-6 text-4xl mt-6 md:px-0">Website Visitors</h1>
          <p className="px-6 mt-4 leading-loose md:px-0">
            ...
            understand how our visitors use our website. From time to time, we
            ...
            leaving comments on blog posts. We only disclose logged in user and
            commenter IP addresses under the same circumstances that we use and
        ...
        <section>
          ...
          <p className="px-6 mt-8 leading-loose md:px-0">
            ...
            require us to gather personally-identifying information. The amount
            and type of information that we gather depends on the nature of the
            interaction. For example, we ask visitors who sign up for a
            newsletter to provide their email address.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="px-6 mt-8 leading-loose md:px-0">
            ...
            do the following at any time by contacting us via our contact page:
          </p>
        ...
        <section>
          <h1 className="px-6 text-4xl mt-6 md:px-0">Security</h1>
          <p className="px-6 mt-8 leading-loose md:px-0">
        ...
        <section>
          <h1 className="px-6 text-4xl mt-6 md:px-0">Advertisements</h1>
          <p className="px-6 mt-8 leading-loose md:px-0">
            ...
            cookies by our website and does not cover the use of cookies by any
            advertisers.
          </p>
        </section>
        ...
        <section>
          <h1 className="px-6 text-4xl mt-6 md:px-0">Remarketing</h1>
          <p className="px-6 mt-8 leading-loose md:px-0">
            We may use remarketing services to advertise on third party websites
            (including Google, Facebook and Others) to previous visitors to our
            site. It could mean that we advertise to previous visitors who may
            not have completed a task on our site, for example using the contact
            form to make an enquiry. This could be in the form of an
            advertisement on search results pages, or a site in the Display
            Network. Third-party vendors, including Google and Facebook, use
            ...
            policy and the ad network’s privacy policy. You can opt out of
            remarketing or interest-based advertising entirely by cookie
        ...
        <section>
          ...
          <p className="px-6 mt-8 leading-loose md:px-0">
            ...
            services available on our website, and (ii) that have agreed not to
            ...
            country; by using our website, you consent to the transfer of such
            information to them. We will not rent or sell potentially
            personally-identifying and personally-identifying information to
            anyone. Other than to our employees, contractors and affiliated
            ...
            website, third parties or the public at large. If you are a
            registered user of our website and/or have supplied your email
            ...
            what’s going on with our website and our products. We primarily use
            ...
            respond to your request or to help us support other users. When the
            user registers on our website to purchase the products or services,
            they provide us with the email address and automatically agree to
            ...
            of promotional emails, sending an email to
            support@getglucoguardian.com. Sometimes it takes time for our system
            to completely remove it from the database, so we invite you to wait
            a reasonable time, in which you may receive service-related
            announcements. We take all measures reasonably necessary to protect
        ...
        <section>
          <h1 className="px-6 text-4xl mt-6 md:px-0">Aggregated Statistics</h1>
          <p className="px-6 mt-8 leading-loose md:px-0">
        ...
        <section>
          <h1 className="px-6 text-4xl mt-6 md:px-0">Affiliate Disclosure</h1>
          <p className="px-6 mt-8 leading-loose md:px-0">
            This site may use affiliate links and earn a commission from certain
            links. This does not affect your purchases or the price you may pay.
          </p>
        </section>

        <section>
          <h1 className="px-6 text-4xl mt-6 md:px-0">Cookies</h1>
          <p className="px-6 mt-8 leading-loose md:px-0">
            ...
            returns. We use cookies to help is identify and track visitors,
            their usage of this website and their website access preferences.
            Visitors who do not wish to have cookies placed on their computers
            should set their browsers to refuse cookies before using this
            website, with the drawback that certain features may not function
        ...
        <section>
          <h1 className="px-6 text-4xl mt-6 md:px-0">E-commerce</h1>
          <p className="px-6 mt-8 leading-loose md:px-0">
            ...
            required to process those transactions. In each case, we collect
            such information only insofar as is necessary or appropriate to
            fulfil the purpose of the visitor’s interaction with this site. We
            do not disclose personally-identifying information other than as
        ...
        <section>
          <h1 className="px-6 text-4xl mt-6 md:px-0">Assignment</h1>
          <p className="px-6 mt-8 leading-loose md:px-0">
            ...
            associated with the Sites. As a result, please be aware that in such
            event we may transfer some or all of your information to a company
            acquiring all or part of our assets or to another company with which
            we have merged. Under such circumstances we would, to the extent
            possible, require the acquiring party to follow the practices
        ...
        <section>
          <h1 className="px-6 text-4xl mt-6 md:px-0">Privacy Policy Changes</h1>
          <p className="px-6 mt-8 leading-loose md:px-0">
        ...
        <section>
          ...
          <p className="px-6 mt-8 leading-loose md:px-0">
            ...
            contact us by clicking in this contact{" "}
            <u>
              <a
      ...
      <footer className="text-center mt-16 py-10 bg-slate-100">
        <div className="container mx-auto">
          ...
          <p className="px-6 mt-4 text-sm md:px-0">
            © Gluco Guardian Research 2024 All Rights Reserved. 7780 49th St
