...
export function VslSection() {
  ...
  function insertVideo() {
    return new Promise<void>((resolve) => {
      ...
      script.src =
        "https://scripts.converteai.net/bbdb9907-ae9e-49fa-8d8b-b1d3886ec07c/players/677c4b799edff29f1f17cbc3/player.js";
      script.async = true;
    ...
    lg:flex-row items-center justify-between text-background"
      >
        ...
        <div>
          ...
          >
            <div
              id="vid_677c4b799edff29f1f17cbc3"
              style={{
                position: "relative",
                width: "100%",
                height: "100%",
            ...
            >
              <img
                id="thumb_67731973e548d24d0424c7cd"
              ...
              />
              <div
                id="backdrop_67731973e548d24d0424c7cd"
                style={{
