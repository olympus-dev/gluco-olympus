  ...
  return (
    <div>
      <main className="container mx-auto mt-6">
        <section>
          <h1 className="text-5xl text-center mt-16">Return Policy</h1>
        </section>

        <section>
          <h1 className="px-6 text-4xl mt-12 md:px-0">Returns </h1>
          <p className="px-6 mt-8 leading-loose md:px-0">
            ...
            Product to the address provided to receive a refund at your cost
        ...
        <section>
          <h1 className="px-6 text-4xl mt-6 md:px-0">Non-returnable items:</h1>
          <p className="px-6 mt-4 leading-loose md:px-0">
            Gift cards Downloadable software products Some health and personal
            care items To complete your return, we require a receipt or proof of
            purchase. Please do not send your purchase back to the manufacturer.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="px-6 mt-8 leading-loose md:px-0">
            ...
            reasons not due to our error Any item that is returned more than 60
            days after purchase
          </p>
        </section>
        ...
        <section>
          <h1 className="px-6 text-4xl mt-6 md:px-0">Gifts</h1>
          <p className="px-6 mt-8 leading-loose md:px-0">
