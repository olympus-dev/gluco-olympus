  ...
  return (
    <div>
      <main className="container mx-auto mt-6">
        ...
        <section>
          <h1 className="px-6 text-4xl mt-12 md:px-0">
        ...
        <section>
          <h1 className="px-6 text-4xl mt-6 md:px-0">5.Termination. </h1>
          <p className="px-6 mt-8 leading-loose md:px-0">
        ...
        <section>
          <h1 className="px-6 text-4xl mt-6 md:px-0">6. Miscellaneous.</h1>
          <p className="px-6 mt-8 leading-loose md:px-0">
            ...
            You agree that any legal action or proceeding betweenDaily Health
            ...
            modify any provision of this Agreement. Daily Health may assign its
            rights and duties under this Agreement to any party at any time
            without notice to you.
          </p>
          <p className="px-6 mt-4 leading-loose md:px-0 font-bold">
